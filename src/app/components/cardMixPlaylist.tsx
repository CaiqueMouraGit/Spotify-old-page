...
const CardMixPlaylist = (props: any) => {
    ...
    return (
        <div className={`group p-3 bg-zinc-900 hover:bg-zinc-500 rounded-md flex flex-col items-center justify-center overflow-hidden hover:cursor-pointer transition-all duration-200 ease-in-out ${props.disable}`}>
            ...
            <div className="w-full overflow-hidden text-lg text-left font-bold sm:text-base sm:font-semibold lg:text-lg lg:font-bold mt-2">
                {props.children}
...
export default CardMixPlaylist;